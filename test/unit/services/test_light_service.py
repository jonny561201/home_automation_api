...
class TestLightService:
    ...
    def test_create_start_light_alarm__should_create_thread(self, mock_thread, mock_db, mock_light):
    ...
    def test_create_start_light_alarm__should_make_call_to_get_api_key(self, mock_thread, mock_db, mock_light):
        create_start_light_alarm()

        mock_light.get_instance.return_value.get_light_api_key.assert_called_with()

    def test_create_start_light_alarm__should_make_call_to_get_alarm_light_group(self, mock_thread, mock_db, mock_light):
        create_start_light_alarm()

        mock_db.return_value.__enter__.return_value.get_preferences_by_user.assert_called()

    def test_create_start_light_alarm__should_make_call_to_get_alarm_light_group_using_user_id_from_settings(self, mock_thread, mock_db, mock_light):
        create_start_light_alarm()

        mock_db.return_value.__enter__.return_value.get_preferences_by_user.assert_called_with(self.USER_ID)

    def test_create_start_light_alarm__should_create_light_state_object(self, mock_thread, mock_db, mock_light):
        time = datetime.time()
        days = 'MonTueWed'
        group_id = 12
    ...
    def test_create_start_light_alarm__should_not_create_thread_when_alarm_time_is_none(self, mock_thread, mock_db, mock_light):
    ...
    def test_create_start_light_alarm__should_not_create_thread_when_alarm_is_none(self, mock_thread, mock_db, mock_light):
    ...
    def test_create_start_light_alarm__should_not_create_thread_when_light_group_id_is_none(self, mock_thread, mock_db, mock_light):
    ...
    def test_create_start_light_alarm__should_return_none_when_api_key_raises_bad_dependency(self, mock_thread, mock_db, mock_light):
        mock_light.side_effect = FailedDependency()
