...
class TestUserDatabase:
    ...
    def test_update_schedule_task_by_user_id__should_query_for_user(self):
        task_id = 'asd123'
        task = {'task_id': task_id, 'alarm_light_group': '1', 'alarm_group_name': 'jkasdhj', 'alarm_days': 'Mon', 'alarm_time': time()}
    ...
    def test_update_schedule_task_by_user_id__should_update_task_id(self, mock_uuid):
        task_id = 'asd123'
        task = {'task_id': task_id, 'alarm_light_group': '1', 'alarm_group_name': 'asdf', 'alarm_days': 'Mon', 'alarm_time': time()}
    ...
    def test_update_schedule_task_by_user_id__should_update_task_group_id(self):
        new_group_id = '1'
        task = {'task_id': 'asdfasd', 'alarm_light_group': new_group_id, 'alarm_group_name': 'test', 'alarm_days': 'Mon', 'alarm_time': time()}
    ...
    def test_update_schedule_task_by_user_id__should_update_task_group_name(self):
        group_name = 'doorwell'
        task = {'task_id': 'asdfasd', 'alarm_light_group': '3', 'alarm_group_name': group_name, 'alarm_days': 'Mon', 'alarm_time': time()}
        existing_task = ScheduleTasks(alarm_light_group='2')
        self.SESSION.query.return_value.filter_by.return_value.first.return_value = existing_task
        self.DATABASE.update_schedule_task_by_user_id(self.USER_ID, task)
    ...
    def test_update_schedule_task_by_user_id__should_update_task_days(self):
        days = 'MonTue'
        task = {'task_id': 'asdfasd', 'alarm_light_group': '3', 'alarm_group_name': 'bedroom', 'alarm_days': days, 'alarm_time': time()}
        existing_task = ScheduleTasks(alarm_light_group='2')
        self.SESSION.query.return_value.filter_by.return_value.first.return_value = existing_task
        self.DATABASE.update_schedule_task_by_user_id(self.USER_ID, task)
    ...
    def test_update_schedule_task_by_user_id__should_update_task_time(self):
        alarm_time = time.fromisoformat('00:00:00')
        task = {'task_id': 'asdfasd', 'alarm_light_group': '3', 'alarm_group_name': 'bedroom', 'alarm_days': 'Mon', 'alarm_time': alarm_time}
        existing_task = ScheduleTasks(alarm_light_group='2')
        self.SESSION.query.return_value.filter_by.return_value.first.return_value = existing_task
        self.DATABASE.update_schedule_task_by_user_id(self.USER_ID, task)
