...
class TestLoginController:
    ...
    def test_get_login__should_call_validate_credentials_with_post_body(self, mock_jwt, mock_db, mock_email):
    ...
    def test_get_login__should_call_extract_credentials(self, mock_jwt, mock_db, mock_email):
        mock_jwt.extract_credentials.return_value = (self.USER, self.PWORD)
        get_login(self.BASIC_AUTH_TOKEN)

        mock_jwt.extract_credentials.assert_called_with(self.BASIC_AUTH_TOKEN)

    def test_get_login__should_call_create_jwt_token_with_database_response(self, mock_jwt, mock_db, mock_email):
    ...
    def test_get_login__should_return_response_from_jwt_service(self, mock_jwt, mock_db, mock_email):
        mock_jwt.extract_credentials.return_value = (self.USER, self.PWORD)
    ...
    def test_get_user_preferences__should_validate_bearer_token(self, mock_jwt, mock_db, mock_email):
        get_user_preferences(self.BASIC_AUTH_TOKEN, self.USER_ID)

        mock_jwt.is_jwt_valid.assert_called_with(self.BASIC_AUTH_TOKEN)

    def test_get_user_preferences__should_call_get_preferences_by_user(self, mock_jwt, mock_db, mock_email):
        get_user_preferences(self.BASIC_AUTH_TOKEN, self.USER_ID)

        mock_db.return_value.__enter__.return_value.get_preferences_by_user.assert_called_with(self.USER_ID)

    def test_get_user_preferences__should_return_preferences_response(self, mock_jwt, mock_db, mock_email):
    ...
    def test_save_user_preferences__should_validate_bearer_token(self, mock_jwt, mock_db, mock_email):
    ...
    def test_save_user_preferences__should_call_insert_preferences_by_user_with_user_id(self, mock_jwt, mock_db, mock_email):
        bearer_token = 'fakeBearerToken'
        request_data = json.dumps({}).encode()
    ...
    def test_save_user_preferences__should_call_insert_preferences_by_user_with_user_info(self, mock_jwt, mock_db, mock_email):
        bearer_token = 'fakeBearerToken'
