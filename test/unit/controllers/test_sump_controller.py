...
class TestSumpController:
    ...
    def test_get_sump_level__should_call_get_current_sump_level_by_user(self, mock_sump, mock_user, mock_jwt):
        ...
        mock_sump.return_value.__enter__.return_value.get_current_sump_level_by_user.assert_called_with(self.USER_ID)
    ...
    def test_get_sump_level__should_return_response_with_distance(self, mock_sump, mock_user, mock_jwt):
        ...
        mock_sump.return_value.__enter__.return_value.get_current_sump_level_by_user.return_value = {'currentDepth': distance, 'warningLevel': 0}
        mock_sump.return_value.__enter__.return_value.get_average_sump_level_by_user.return_value = {'averageDepth': distance, 'testItem': 123}
    ...
    def test_get_sump_level__should_return_response_with_distance_converted_to_imperial(self, mock_sump, mock_user, mock_jwt):
        ...
        mock_sump.return_value.__enter__.return_value.get_current_sump_level_by_user.return_value = {'currentDepth': current_distance, 'warningLevel': 0}
        mock_sump.return_value.__enter__.return_value.get_average_sump_level_by_user.return_value = {'averageDepth': average_distance, 'testItem': 123}
    ...
    def test_get_sump_level__should_call_get_average_sump_level_by_user(self, mock_sump, mock_user, mock_jwt):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
        get_sump_level(self.BEARER_TOKEN)
