...
@patch('svc.controllers.devices_controller.api_utils')
...
class TestDeviceController:
    ...
    def test_get_user_devices__should_validate_jwt(self, mock_jwt, mock_db, mock_api):
        get_user_devices(self.BEARER_TOKEN)

        mock_jwt.get_instance.return_value.verify_jwt.assert_called_with(self.BEARER_TOKEN)

    def test_get_user_devices__should_call_database_with_user_id(self, mock_jwt, mock_db, mock_api):
    ...
    def test_get_user_devices__should_map_devices_from_database(self, mock_jwt, mock_db, mock_api):
    ...
    def test_get_user_devices__should_return_empty_list_if_no_devices(self, mock_jwt, mock_db, mock_api):
    ...
    def test_add_device__should_validate_jwt(self, mock_jwt, mock_db, mock_api):
        request_data = {'roleName': None, 'ipAddress': None, 'ipPort': None}
        add_device(self.BEARER_TOKEN, request_data)
        mock_jwt.get_instance.return_value.verify_jwt.assert_called_with(self.BEARER_TOKEN)

    def test_add_device__should_call_add_new_device_with_user_id(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
        request_data = {'roleName': None, 'ipAddress': None, 'ipPort': None}
        add_device(self.BEARER_TOKEN, request_data)
        mock_db.return_value.__enter__.return_value.add_new_device.assert_called_with(self.USER_ID, ANY, ANY, ANY)

    def test_add_device__should_call_add_new_device_with_role_name(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
    ...
    def test_add_device__should_call_add_new_device_with_ip_address(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
    ...
    def test_add_device__should_call_add_new_device_with_ip_port(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
    ...
    def test_add_device__should_raise_bad_request_exception_if_key_missing(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
        request_data = {}
        with pytest.raises(BadRequest):
            add_device(self.BEARER_TOKEN, request_data)

    def test_add_device__should_return_response_from_adding_to_database(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
    ...
    def test_add_device__should_assign_auth0_roles_when_roles_exist(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
        ...
        mock_api.assign_auth0_roles.assert_called_with(self.AUTH0_ID, ['rol_abc'])

    def test_add_device__should_not_assign_auth0_roles_when_no_roles(self, mock_jwt, mock_db, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
        mock_db.return_value.__enter__.return_value.get_role_ids_by_device_ids.return_value = []
        request_data = {'roleName': 'fakeName', 'ipAddress': '1.1.1.1', 'ipPort': 443}
...
class TestRegisterDiscoveredDevice:
    ...
    def test_register_discovered_device__should_validate_jwt(self, mock_jwt, mock_db, mock_user, mock_api):
        register_discovered_device_to_user(self.BEARER_TOKEN, self.DEVICE_ID, {})

        mock_jwt.get_instance.return_value.verify_jwt.assert_called_with(self.BEARER_TOKEN)

    def test_register_discovered_device__should_call_register_device_to_user(self, mock_jwt, mock_db, mock_user, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
    ...
    def test_register_discovered_device__should_get_role_ids_by_device_ids(self, mock_jwt, mock_db, mock_user, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
    ...
    def test_register_discovered_device__should_assign_auth0_roles_when_roles_exist(self, mock_jwt, mock_db, mock_user, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
        mock_db.return_value.__enter__.return_value.get_role_ids_by_device_ids.return_value = ['rol_abc']
    ...
    def test_register_discovered_device__should_not_assign_roles_when_empty(self, mock_jwt, mock_db, mock_user, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
        mock_db.return_value.__enter__.return_value.get_role_ids_by_device_ids.return_value = []
    ...
    def test_register_discovered_device__should_return_device_id(self, mock_jwt, mock_db, mock_user, mock_api):
        mock_jwt.get_instance.return_value.verify_jwt.return_value = self.CLAIMS
